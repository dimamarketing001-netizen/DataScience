    ...
    init: async function() {
        ...
        function openConfirmIncomeModal(incomeId, isCurrentlyConfirmed) {
            ...
            text.textContent = willConfirm
                ? 'Вы уверены, что хотите подтвердить этот платёж? Статус счёта в Битрикс24 будет изменён на "Подтверждённый".'
            ...
            const stageNames = {
                ...
                'DC18:NEW':          'Новый',
                // Продажа (cat 0)
                'WON':               'Полный первый платеж',
                'EXECUTING':         'Частичная оплата',
            };
