BX24.ready(() => {
    ...
    if (dashboardContainer) {
        ...
        console.log("Простой скрипт успешно выполнен. Элемент 'dashboard-container' найден и изменен.");
    } else {
        // Если контейнер не найден, выводим критическую ошибку в консоль.
        // Это поможет нам понять, загружается ли вообще правильный HTML.
        console.error("Критическая ошибка: Элемент #dashboard-container не найден. Невозможно отобразить приветствие.");
    }
});
